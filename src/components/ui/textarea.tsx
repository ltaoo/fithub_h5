...
const Textarea = (props: { store: InputCore<string> } & JSX.HTMLAttributes<HTMLTextAreaElement>) => {
  ...
  return (
    <textarea
      ref={props.ref}
      class={cn(
        "flex h-20 w-full rounded-xl border-2 border-w-fg-3 bg-transparent py-2 px-3 text-sm placeholder:text-w-fg-2 focus:outline-none focus:ring-2 focus:ring-w-bg-3 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-700 dark:text-slate-50 dark:focus:ring-slate-400 dark:focus:ring-offset-slate-900",
        props.class
      )}
      value={value()}
