    ...
    <>
      <div class="flex flex-col gap-4 w-full p-4 bg-white rounded-lg shadow-md">
        ...
        <div class="flex items-center justify-between px-2">
          <div class="nums flex-1">
            <div class="space-y-2">
              ...
              <div class="flex justify-between gap-2">
                ...
                <button
                  class="basis-2/3 p-4 text-xl bg-gray-200 text-white rounded-lg"
                  onClick={() => {
          ...
          <div class="extra w-[80px] ml-2">
            <div class="space-y-2">
              <div
                class="flex-1 p-4 text-xl bg-gray-200 text-white rounded-lg"
                onClick={() => {
              ...
              <div class="flex-1 p-4 text-xl bg-gray-200 rounded-lg opacity-0">
                <div>上</div>
              </div>
              <div class="flex-1 p-4 text-xl bg-gray-200 rounded-lg opacity-0">
                <div>下</div>
