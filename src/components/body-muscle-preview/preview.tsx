...
const default_muscle_id_map: Record<string, string[]> = {
  traps: ["path18", "path16", "path32", "path196", "path200"], // 斜方肌
  lats: ["path24", "path26", "path28", "path30", "path36", "path44", "path56", "path60"], // 背阔肌左右两侧
  lower_back: ["path20", "path22"], // 下背部左右两侧
  shoulders: ["path88", "path96", "path142", "path152"], // 三角肌前中后束
  chest: ["path106", "path138", "path160", "path198"], // 胸大肌左右两侧
  biceps: ["path140", "path148", "path150", "path158"], // 二头肌左右
  triceps: ["path78", "path82", "path84", "path98", "path100", "path102"], // 三头肌左右
