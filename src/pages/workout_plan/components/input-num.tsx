...
export function NumInputView(
  props: { width?: number; store: SingleFieldCore<InputWithKeyboardModel> } & JSX.HTMLAttributes<HTMLDivElement>
) {
      ...
      <Sheet store={$input.ui.$dialog} app={$input.app}>
        <div class="flex flex-col gap-4 w-full p-4">
          <div class="headers flex items-center justify-between px-2">
            <div class="text-3xl font-bold text-w-fg-0">{input().value}</div>
          </div>
