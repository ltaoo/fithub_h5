...
function ArticleUpdateViewModel(props: ViewComponentProps) {
  ...
  const ui = {
    ...
    $form: $editor.ui.$form,
    $btn_update: $editor.ui.$btn_update,
...
export function ArticleUpdateView(props: ViewComponentProps) {
  const [state, vm] = useViewModel(ArticleUpdateViewModel, [props]);
  ...
  return (
    <>
      <PageView
        ...
        operations={
          <div>
            <Button class="w-full" store={vm.ui.$btn_update}>
              编辑
            </Button>
          </div>
        }
