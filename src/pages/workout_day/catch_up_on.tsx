...
export type WorkoutDayCatchUpViewModel = ReturnType<typeof WorkoutDayCatchUpViewModel>;
export function WorkoutDayCatchUpViewModel(props: ViewComponentProps) {
  const request = {
    workout_day: {
  ...
  return {
    ...
    async ready() {
      ...
      const { steps, pending_steps, started_at } = r.data;
      console.log(
...
export function WorkoutDayCatchUpView(props: ViewComponentProps) {
  const [state, vm] = useViewModel(WorkoutDayCatchUpViewModel, [props]);
